      ...
      <div className={`
       ...
       `}>  
        ...
        <div className="p-4 border-t border-gray-800 space-y-2 bg-gray-900 sticky bottom-0 z-50 ">
          <div className="relative flex items-center" onMouseEnter={() => setHoveredItem('Add User')} onMouseLeave={() => setHoveredItem(null)}>
            <Link
              to="/register"
              onClick={() => setIsOpen(false)}
              className="w-full flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-gray-800 hover:text-white transition-all text-left"
            >
            ...
            {isCollapsed && hoveredItem === 'Add User' && (
