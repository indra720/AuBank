  ...
  const startWebRTC = async (stream, roomId) => {
    ...
    const customerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI5ODc2NTQzMjEwIiwicm9sZSI6ImN1c3RvbWVyIiwiZXhwIjoxNzcyMTg3ODY0fQ.Bxkao9AxtFVg1xs3NBH3fG6M2XtaHEqGXO4fhA3_-CM";
  ...
  ws.onmessage = async (event) => {
    ...
    useEffect(() => {
      const customerToken =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI5ODc2NTQzMjEwIiwicm9sZSI6ImN1c3RvbWVyIiwiZXhwIjoxNzcyMTg3ODY0fQ.Bxkao9AxtFVg1xs3NBH3fG6M2XtaHEqGXO4fhA3_-CM";
