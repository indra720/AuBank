...
function RegistrationPage() {
  ...
  const handleStep1Submit = async (e) => {
    ...
    if (role === "agent") {
      ...
      if (!formData.username || !formData.mobile_number)
        return setError("Username and Mobile are required");
    }

    const mobileReqResult = await callApi("/api/verify/mobile/request", {
      mobile_number: formData.mobile_number,
    });
  ...
  const handleResendOtp = async () => {
    ...
    const result = await callApi("/api/verify/mobile/resend", {
      mobile_number: formData.mobile_number,
    });
  ...
  const handleFinalUpdate = async (e) => {
    ...
    const profileResult = await callApi(
      "/api/verify/user/profile-update",
      {
    ...
    // 2. Set Secure MPIN
    const mpinResult = await callApi(
      "/api/auth/set-mpin",
      {
        mpin: formData.mpin,
      },
    ...
    <div className="flex items-center justify-between mb-10 px-2 relative">
      ...
      {[1, 2, 3, 4, 5, 6].map((i) => (
        <div key={i} className="relative z-10 flex flex-col items-center">
          <div
            className={`w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-500 border-4 ${
              step === i
                ? "bg-orange-600 text-white border-orange-100 scale-110 shadow-lg shadow-orange-200"
                : step > i
          ...
          <span
            className={`absolute -bottom-6 text-[10px] font-bold uppercase tracking-tighter whitespace-nowrap transition-colors ${step >= i ? "text-orange-600" : "text-gray-300"}`}
          >
            {i === 1 && "Start"}
            {i === 3 && "Aadhar"}
            {i === 5 && "PAN"}
        ...
        <div className="hidden lg:block w-[40%] relative group bg-gray-900 overflow-hidden">
          ...
          <div className="absolute bottom-12 left-12 right-12 text-white">
            ...
            <p className="text-orange-50/80 font-medium text-sm leading-relaxed max-w-sm">
              Experience the next generation of digital banking with our 100%
              secure and paperless Video KYC process.
            </p>

            <div className="mt-8 flex gap-4">
              <div className="px-4 py-2 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 text-xs font-bold">
                99.9% Uptime
              </div>
              <div className="px-4 py-2 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 text-xs font-bold">
                Bank-Grade Security
              ...
              >
                <div className="mb-6">
                  ...
                  <p className="text-gray-400 font-medium">
                    Choose your role and enter basic details.
                  </p>
                </div>
            ...
            {step === 2 && (
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-gray-400 font-medium">
                    Confirm your number and enter the 6-digit code.
                  </p>
                </div>
                <div className="space-y-5">
                  ...
                  <button
                    type="button"
                    onClick={() => setStep(1)}
                    className="w-full text-xs font-bold text-orange-600 hover:text-orange-700 uppercase tracking-widest mt-4"
                  >
                    Go Back
                  </button>
                </div>
            ...
            {step === 3 && (
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-gray-400 font-medium">
                    We need your Aadhar number for paperless KYC.
                  </p>
                </div>
                <div className="space-y-5">
                  <Input
            ...
            {step === 4 && (
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-gray-400 font-medium">
                    Confirm your Aadhar and enter the OTP sent by UIDAI.
                  </p>
                </div>
                <div className="space-y-5">
                  <Input
            ...
            {step === 5 && (
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-gray-400 font-medium">
                    Finally, provide your Permanent Account Number.
                  </p>
                </div>
                <div className="space-y-5">
                  <Input
            ...
            {step === 6 && (
              ...
              >
                <div className="mb-6">
                  ...
                  <p className="text-gray-400 font-medium">
                    Review your details and set your secure MPIN.
                  </p>
                </div>
                <div className="space-y-4">
                  <Input
            ...
            {step === 1 && (
              <div className="mt-10 pt-8 border-t border-gray-100 flex items-center justify-between text-sm">
                ...
                <button
                  ...
                  className="font-bold text-orange-600 hover:text-orange-700 transition-colors uppercase tracking-widest text-xs"
                >
                  Sign In
                </button>
              </div>
...
function Input({
  ...
  return (
    <div className="group">
      <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-2 ml-1 transition-colors group-focus-within:text-orange-500">
        {label}
      </label>
      <div className="relative">
        <span className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-orange-500 transition-colors duration-300">
          {icon}
        </span>
        <input
          type={type}
